...
public class TSLObjectProxy {
    ...
    protected TSLObjectProxy(Builder builder) {
    ...
    public static class Builder implements TSLBuilder<TSLObjectProxy> {
        ...
        public TSLObjectProxy build() {
            ...
            return new TSLObjectProxy(this);
        }
    }
}
